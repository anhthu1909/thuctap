...
<c:url var="editSurveyTypeURL" value="/quan-tri/kieu-khao-sat/chinh-sua"/>
                        ...
                        <div class="col-xs-12">
                            <form:form class="form-horizontal" role="form" id="formSubmit" modelAttribute="model">
                                <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right" for="name"> Tên kiểu khảo sát </label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right" for="code">
                                        Mã kiểu khảo sát </label>
                                    <div class="col-sm-9">
                                        <form:input path="code" placeholder="VD: thuong-nien" cssClass="col-xs-10 col-sm-5"/>
                                    </div>
                                </div>
        <%--                        <div class="form-group">--%>
