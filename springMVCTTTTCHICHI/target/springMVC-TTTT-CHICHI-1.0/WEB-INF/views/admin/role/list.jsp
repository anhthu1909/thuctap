...
<c:url var="newURL" value="/quan-tri/bai-viet/danh-sach-role"/>
							...
							<div class="table-btn-controls">
								<div class="pull-right tableTools-container">
									<div class="dt-buttons btn-overlap btn-group">
										<c:url var="createNewURL" value="/quan-tri/bai-viet/chinh-sua-role"/>
										<a flag="info"
									...
									<table class="table table-bordered">
										...
										<c:forEach var="item" items="${model.listResult}">
											<tr>
												...
												<td>${item.name}</td>
												<td>
													<c:url var="updateNewURL" value="/quan-tri/bai-viet/chinh-sua-role">
														<c:param name="id" value="${item.id}"/>
													</c:url>
													<a class="btn btn-sm btn-primary btn-edit" data-toggle="tooltip"
													   title="Cập nhật phân quyền" href='${updateNewURL}'><i class="fa fa-pencil-square-o" aria-hidden="true"></i>
													</a>
												</td>
											</tr>
										</c:forEach>
