...
<c:url var="surveyObjectURL" value="/quan-tri/bai-viet/ds-doi-tuong"/>
<c:url var="editSurveyObjectURL" value="/quan-tri/bai-viet/cs-doi-tuong"/>
<c:url var="surveyObjectAPI" value="/api/doituong"/>
<html>
<head>
    ...
    function addSurveyObject(data) {
        $.ajax({
            ...
            error: function (error) {
                window.location.href = "${surveyObjectURL}?&message=error_system";
            }
        });
    }
