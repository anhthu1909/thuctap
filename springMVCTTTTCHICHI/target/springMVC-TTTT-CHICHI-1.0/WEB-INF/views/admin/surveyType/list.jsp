...
<%@ page language="java" contentType="text/html; charset=UTF-8"
		 pageEncoding="UTF-8"%>
<c:url var="kieuAPI" value="/api/kieu"/>
<c:url var="kieuURL" value="/quan-tri/bai-viet/danh-sach-kieu"/>
									...
									<table class="table table-bordered">
										...
										<c:forEach var="item" items="${model.listResult}">
											<tr>
												...
												<td>
													<c:url var="updateNewURL" value="/quan-tri/bai-viet/chinh-sua-kieu">
    ...
    function deleteNew(data) {
        $.ajax({
            ...
            success: function (result) {
                window.location.href = "${kieuURL}?&message=delete_success";
            },
            error: function (error) {
                window.location.href = "${kieuURL}?&message=error_system";
            }
        });
    }
</script>
