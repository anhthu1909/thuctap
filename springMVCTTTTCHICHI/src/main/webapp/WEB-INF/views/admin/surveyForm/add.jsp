...
<c:url var="newURL" value="/quan-tri/bai-viet/danh-sach-pks"/>
<c:url var="editNewURL" value="/quan-tri/bai-viet/chinh-sua-pks"/>
<c:url var="newAPI" value="/api/phieuks"/>
<html>
<head>
    ...
    <div class="container" >
        <div class="col-md-12 mt-3">
            <div class="container text-center mt-3 mb-3">
                <span style="font-size: 32px; font-weight: 700; color:#ec2028;">Thêm câu hỏi mới</span>
            </div>
            <div class="row mt-3 pt-3 pb-3">
                ...
                <div class="col-md-5 float-right " id="getcode">
                    <div class="col-md-12 pb-3 pt-3 text-center" style="border: 1px solid #717171;font-size: 32px; font-weight: 600; border-radius: 05px;" >
